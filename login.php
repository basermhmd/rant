...
$firstName =  $email = $number = $password = $confirm_password = $date =  "";
$firstName_err =  $email_err = $number_err = $password_err = $confirm_password_err = $date_err =  "";
...
if (isset($_POST["register"])) {
  ...
  if (empty($firstName_err)  &&  empty($email_err) && empty($number_err) && empty($password_err) && empty($date_err)  ) {

    $sql = "INSERT INTO users (firstName,email,number,password,date) VALUES (?,?,?,?,?)";
    ...
    if ($stmt = mysqli_prepare($connection, $sql)) {
      ...
      mysqli_stmt_bind_param($stmt, "ssiss", $param_firstName, $param_email, $param_number, $param_password, $param_date);
    ...
    <div class="container" id="container">
        ...
        <div class="form-container sign-in-container">
            <form action="login.php" method="POST" novalidate>
                ...
                <input type="password" name="password" id="password" placeholder="Şifre" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : '' ?>" value="<?php echo $password; ?>" />
                <div class="invalid-feedback"><?php echo $password_err; ?></div>
                <a href="forgotpassword.html">Şifrenizi mi unuttunuz ?</a>
